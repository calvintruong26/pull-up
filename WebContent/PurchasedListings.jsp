...
<body>
	...
	<% if (results == null || results.isEmpty()) { %>
		<h1 style="text-align: center">Sorry, you didn't have any upcoming events...</h1>
		<h2 style="text-align: center"> Please click <a href="FindParking.jsp">HERE</a> to search!</h2>
	<% } else { %>
	<h1 style="text-align: center">Here's Your Upcoming Listings</h1>
